            ...
            <div className="work-box" key={index}>
              <div className="work-info">
                <div className="work-title">
                  ...
                  <div>
                    <h4>{project.title}</h4>
                    <p style={{ marginTop: "10px", fontSize: "14px", lineHeight: "1.6", color: "#bbb", textAlign: "left" }}>{project.description}</p>
                  </div>
                </div>
                <h4>Tools and features</h4>
                <p style={{ marginBottom: "15px" }}>{project.tools}</p>
                <div>
                  <a href={project.link} target="_blank" rel="noreferrer" style={{ display: "inline-block", padding: "6px 16px", border: "1px solid var(--accentColor)", color: "var(--accentColor)", borderRadius: "20px", fontSize: "13px", textDecoration: "none", transition: "0.3s", cursor: "pointer" }} onMouseOver={(e) => {e.currentTarget.style.backgroundColor="var(--accentColor)"; e.currentTarget.style.color="#000"}} onMouseOut={(e) => {e.currentTarget.style.backgroundColor="transparent"; e.currentTarget.style.color="var(--accentColor)"}}>
                    {project.linkText}
                  </a>
                </div>
              </div>
